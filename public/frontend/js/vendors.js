...
!function (t, e) {
    ...
    d.constructor = o, d._create = function () {
        ...
        a.transform = this.getTranslate(s, r), this.transition({
            to: a, onTransitionEnd: {transform: this.layoutPosition}, isCleaning: !0
        })
...
!function (a, b) {
    ...
    return b.contains = function (a) {
        ...
        return this.y < b.y && (c = new a({
            x: this.x, y: this.y, width: this.width, height: b.y - this.y
        }), d.push(c)), e > g && (c = new a({
            x: g, y: this.y, width: e - g, height: this.height
        }), d.push(c)), f > h && (c = new a({
            x: this.x, y: h, width: this.width, height: f - h
        }), d.push(c)), this.x < b.x && (c = new a({
            x: this.x, y: this.y, width: b.x - this.x, height: this.height
        }), d.push(c)), d
    }, b.canFit = function (a) {
    ...
    j._create = function () {
        ...
        if (d && d.isPlacing) b = d.rect; else {
            ...
            b = new c({
                x: this._getOption("originLeft") ? e.left : e.right, y: this._getOption("originTop") ? e.top : e.bottom
            })
        }
...
!function (n, t) {
    ...
    var s = new f, a = function n(t, r, i) {
            return t instanceof RegExp ? function (n, t) {
                if (!t) return n;
                var r = n.source.match(/\((?!\?)/g);
                if (r) for (var i = 0; i < r.length; i++) t.push({
                    name: i, prefix: null, delimiter: null, optional: !1, repeat: !1, pattern: null
                });
                return n
    ...
    function d(n, t) {
        for (var r, i = [], e = 0, o = 0, u = "", f = t && t.delimiter || v, s = t && t.whitelist || void 0, a = !1; null !== (r = p.exec(n));) {
            var c = r[0], h = r[1], l = r.index;
            if (u += n.slice(o, l), o = l + c.length, h) u += h[1], a = !0; else {
                var d = "", m = r[2], y = r[3], g = r[4], P = r[5];
                if (!a && u.length) {
                    var E = u.length - 1, x = u[E];
    ...
    var P = {
        container: "container", namespace: "namespace", prefix: "data-barba", prevent: "prevent", wrapper: "wrapper"
    }, E = function () {
    ...
    var x = new E, A = function (n, t) {
    ...
    }, T = a, j = {updateNext: A, pathToRegexp: T}, R = function () {
        return window.location.origin
    }, O = function (n) {
        var t = n || window.location.port, r = window.location.protocol;
        ...
        }, getOrigin: R, getPort: O, getPath: k, parse: C, parseQuery: L, clean: M
    }, $ = function (n) {
        if (this.T = [], "boolean" == typeof n) this.j = n; else {
    ...
    var I, U = function () {
        ...
        var t = n.exports = function (n, t) {
            return t = t || function () {
                ...
                var r = !1, i = arguments, e = new Promise(function (t, e) {
                    var o, u = n.apply({
                        async: function () {
                            return r = !0, function (n, r) {
                                n ? e(n) : t(r)
                            }
                        }
    ...
    }(I = {exports: {}}), I.exports), Y = function (n) {
        void 0 === n && (n = []), this.logger = new u("@barba/core"), this.all = [], this.appear = [], this.O = [{
            name: "namespace", type: "strings"
        }, {name: "custom", type: "function"}], n && (this.all = this.all.concat(n)), this.k()
    };
    Y.prototype.add = function (n, t) {
        ...
        var o = !0, u = !1, f = n, s = t.name, a = s, c = s, h = s, l = e ? f[e] : f,
    ...
    Z.prototype.get = function (n, t) {
        ...
        var t = n.data, i = n.transition, e = n.page, o = n.wrapper;
        try {
            var u = this;
    ...
    tn.prototype.U = function (n) {
        var t = this;
        return function (r) {
            var i = n.match(/enter/i) ? r.next : r.current, e = t.byNamespace.get(i.namespace);
            e && e[n] && e[n](r)
        }
    ...
    var rn = {
        container: void 0, html: void 0, namespace: void 0, url: {hash: void 0, href: void 0, path: void 0, query: {}}
    }, en = function () {
    ...
    return en.prototype.use = function (n, t) {
        ...
        var e = n.timeout;
        void 0 === e && (e = 2e3);
        var o = n.requestError, f = n.cacheIgnore;
        void 0 === f && (f = !1);
        ...
        try {
            var n = this, t = function () {
                if (n.transitions.hasAppear) {
                    var t = r(function () {
                        var t = n.V, r = n.transitions.get(t, {appear: !0});
            ...
            function o() {
                ...
                var f = r(function () {
                    ...
                    return Promise.resolve(e.transitions.doPage({
                        data: o, page: u, transition: n, wrapper: e.X
                    })).then(function () {
                        e.Y(o), e._()
                    })
                }, function (n) {
        ...
        this.V = {
            current: t, next: Object.assign({}, this.schemaPage), trigger: void 0
...
!function (t, n) {
    ...
    return o.prototype = {
        ...
        tolerance: {up: 0, down: 0}, offset: 0, scroller: t() ? window : null, classes: {
    ...
    function y() {
        g.length && (g.forEach(function (e, t) {
            var n = e.instance, o = e.oldData, i = n.$item.getBoundingClientRect(), a = {
                    width: i.width, height: i.height, top: i.top, bottom: i.bottom, wndW: b.window.innerWidth, wndH: h
...
!function (e, t) {
    ...
    function w(e) {
        void 0 === e && (e = {});
        var t = e.defaultModifiers, n = void 0 === t ? [] : t, r = void 0 === (e = e.defaultOptions) ? N : e;
                ...
                state: s, setOptions: function (i) {
                    ...
                    if (!p) {
                        ...
                        if (x(t, e = e.popper)) for (s.rects = {
                            reference: u(t, v(e), "fixed" === s.options.strategy), popper: d(e)
                            ...
                            r = void 0 === r ? {} : r, n = n.name, "function" == typeof e && (s = e({
                                state: s, options: r, name: n, instance: c
                            }) || s)
                        }
                    }
                }, update: b((function () {
    ...
    function j(e) {
        var t, r = e.popper, o = e.popperRect, i = e.placement, a = e.offsets, f = e.position, p = e.gpuAcceleration,
    ...
    function B(e, t, r) {
        return t = "clippingParents" === t ? function (e) {
            var t = m(e), n = 0 <= ["absolute", "fixed"].indexOf(p(e).position) && i(e) ? v(e) : e;
            ...
            var d = parseFloat(u.borderRightWidth) || 0, l = parseFloat(u.borderBottomWidth) || 0,
    ...
    function H(e, n) {
        ...
        p = e.rects.popper, a = B(o(c = e.elements[c ? "popper" === i ? "reference" : "popper" : i]) ? c : c.contextElement || s(e.elements.popper), a, f), c = M({
            reference: f = t(u), element: p, strategy: "absolute", placement: n
    ...
    var q = ["top", "bottom", "right", "left"], S = q.reduce((function (e, t) {
        ...
        N = {placement: "bottom", modifiers: [], strategy: "absolute"}, V = {passive: !0},
        I = {top: "auto", right: "auto", bottom: "auto", left: "auto"},
        _ = {left: "right", right: "left", bottom: "top", top: "bottom"}, U = {start: "end", end: "start"}, z = [{
            name: "eventListeners", enabled: !0, phase: "write", fn: function () {
                ...
                })), a && s.addEventListener("resize", r.update, V), function () {
            ...
            name: "flip", enabled: !0, phase: "main", fn: function (e) {
                ...
                if (e = e.name, !t.modifiersData[e]._skip) {
                    ...
                    var i = n.fallbackPlacements, a = n.padding, s = n.boundary, f = n.rootBoundary, p = n.altBoundary,
                        c = n.flipVariations, u = void 0 === c || c, d = n.allowedAutoPlacements;
                    ...
                    for (var h = l[0], v = 0; v < l.length; v++) {
                        var g = l[v], b = y(g), x = "start" === g.split("-")[1], w = 0 <= ["top", "bottom"].indexOf(b),
                            O = w ? "width" : "height",
            ...
            name: "preventOverflow", enabled: !0, phase: "main", fn: function (e) {
                ...
                a = "x" === c ? "y" : "x";
                var u = t.modifiersData.popperOffsets, l = t.rects.reference, m = t.rects.popper,
                    h = "function" == typeof s ? s(Object.assign({}, t.rects, {placement: t.placement})) : s;
                if (s = {x: 0, y: 0}, u) {
                    if (o) {
                        var g = "y" === c ? "top" : "left", b = "y" === c ? "bottom" : "right",
                            x = "y" === c ? "height" : "width";
                        o = u[c];
                        var w = u[c] + n[g], M = u[c] - n[b], j = i ? -m[x] / 2 : 0, E = "start" === f ? l[x] : m[x];
            ...
            name: "arrow", enabled: !0, phase: "main", fn: function (e) {
                var t, n = e.state;
                e = e.name;
                var r = n.elements.arrow, o = n.modifiersData.popperOffsets, i = y(n.placement), a = O(i);
                if (i = 0 <= ["left", "right"].indexOf(i) ? "height" : "width", r && o) {
                    var s = n.modifiersData[e + "#persistent"].padding, f = d(r), p = "y" === a ? "top" : "left",
                        c = "y" === a ? "bottom" : "right",
...
!function (e, t) {
    ...
    return function (e) {
        ...
        n.r(t), function (e) {
            ...
            function c(e, t) {
                var n = e.getBoundingClientRect(), i = n.bottom, o = (n.height, n.top), s = t.getBoundingClientRect();
            ...
            function p(e, t) {
                this.el = e, this.config = Object.assign({}, a, t || {}), this.data = this.config.data, this.selectedOptions = [], this.placeholder = s(this.el, "placeholder") || this.config.placeholder || "Select an option", this.dropdown = null, this.multiple = s(this.el, "multiple"), this.disabled = s(this.el, "disabled"), this.create()
            }
            ...
            p.prototype.create = function () {
                ...
                var e = this, t = this.el.querySelectorAll("option"), n = [], i = [], o = [];
                t.forEach((function (t) {
                    var o = {text: t.innerText, value: t.value}, s = {
                        selected: null != t.getAttribute("selected") || t.value == e.el.value,
                        disabled: null != t.getAttribute("disabled"),
                        display: !0
                    };
                    n.push(o), i.push({data: o, attributes: s})
                })), this.data = n, this.options = i, this.options.forEach((function (e) {
                ...
                var e = this, t = this.dropdown.querySelector("ul");
                t.scrollTop = 0, t.innerHTML = "", this.options.forEach((function (n) {
                    n.display && t.appendChild(e._renderItem(n))
                }))
            }, p.prototype._renderItem = function (e) {
                var t, n = this, i = document.createElement("li");
                ...
                return (t = i.classList).add.apply(t, o), i.innerHTML = e.data.text, i.addEventListener("click", (function (t) {
                ...
                r(n, "disabled") || (this.dropdown.classList.remove("open"), this.multiple ? r(n, "selected") || (d(n, "selected"), this.selectedOptions.push(e)) : (this.selectedOptions.forEach((function (e) {
                    l(e.element, "selected")
                })), d(n, "selected"), this.selectedOptions = [e]), this.dispatchOnChanged(t), this._renderSelectedItems(), this.updateSelectValue())
                ...
                e.preventDefault();
                var t = this.dropdown.querySelector(".focus"), n = this.dropdown.classList.contains("open");
                if (13 == e.keyCode) n ? i(t, new CustomEvent("select", {detail: e})) : i(this.dropdown); else if (40 == e.keyCode) {
                    if (n) {
                ...
                if ("" == (n = n.toLowerCase())) this.options.forEach((function (e) {
                    e.display = !0
                })), this._renderItems(); else if (t) {
                    var i = new RegExp(n);
                    this.options.forEach((function (e) {
                        var t = e.data.text.toLowerCase(), n = i.test(t);
                        e.display = n
                    })), this._renderItems()
                }
...
!function (t, e) {
    ...
    _(ct + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", function (t) {
        ...
        sortChildren: !1, defaults: R, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0
    }), U.stringFilter = pb;
    var re = {
        ...
        }, install: K, effects: lt, ticker: Mt, updateRoot: Bt.updateRoot, plugins: ht, globalTimeline: F, core: {
            PropTween: ee, globals: N, Tween: Ht, Timeline: Bt, Animation: Rt, getCache: Z, _removeLinkedListItem: pa
        }
    };
    ...
    function ud(t, e, r, i) {
        ...
        if (v.b = r, v.e = i, r += "", "auto" === (i += "") && (t.style[e] = i, i = hd(t, e) || i, t.style[e] = r), pb(s = [r, i]), i = s[1], u = (r = s[0]).match(tt) || [], (i.match(tt) || []).length) {
            for (; o = tt.exec(i);) d = o[0], p = i.substring(y, o.index), l ? l = (l + 1) % 5 : "rgba(" !== p.substr(-5) && "hsla(" !== p.substr(-5) || (l = 1), d !== (f = u[T++] || "") && (h = parseFloat(f) || 0, m = f.substr((h + "").length), (g = "=" === d.charAt(1) ? +(d.charAt(0) + "1") : 0) && (d = d.substr(2)), c = parseFloat(d), _ = d.substr((c + "").length), y = tt.lastIndex - _.length, _ || (_ = _ || U.units[e] || m, y === i.length && (i += _, v.e += _)), m !== _ && (h = sd(t, e, f, _) || 0), v._pt = {
                _next: v._pt, p: p || 1 === T ? p : ",", s: h, c: g ? g * c : c - h, m: l && l < 4 ? Math.round : 0
            });
...
!function (t, e) {
    ...
    var e, u, x, s, f, a, g, i = {
        version: "3.3.4", name: "scrollTo", rawVars: 1, register: function register(t) {
            e = t, r()
...
!function (e, t) {
    ...
    var t, k, h, d, l, b = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi,
        ...
        a = {
            version: "3.3.4", name: "drawSVG", register: function register(e) {
                t = e, x()
