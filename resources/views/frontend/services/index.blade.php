...
@section('title',__('backend.projects'))
@section('front')

    <section class="page-masthead">
        <div data-parallax="0.6" class="page-masthead__bg">
            <div data-parallax-target class="bg-image js-lazy"
                 data-originalbg="{{asset('frontend/img/11.jpg')}}"></div>
        </div>
                    ...
                    <div class="pagination -section">
                        <div class="pagination__nav">
                            @if ($projects->previousPageUrl())
                                <a href="{{ $projects->previousPageUrl() }}" class="nav-icon -left" data-barba>
                        ...
                        <div class="pagination__content">
                            @for ($i = 1; $i <= $projects->lastPage(); $i++)
                                <a href="{{ $projects->url($i) }}"
                                   @if ($projects->currentPage() === $i) class="is-active"
                        ...
                        <div class="pagination__nav">
                            @if ($projects->nextPageUrl())
                                <a href="{{ $projects->nextPageUrl() }}" class="nav-icon -right" data-barba>
                                    <div class="nav-icon__circle">
